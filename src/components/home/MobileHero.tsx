...
export default function MobileHero({
  ...
  return (
    <section className="block md:hidden pt-3 pb-16 px-4 text-center relative overflow-hidden">
      
      {/* 
        ========================================================================
        Ultra-Soft & Gentle Ambient Golden Glow (خفيف جداً وناعم وراقي زي الكمبيوتر)
        ========================================================================
      */}
      <div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-md h-[360px] pointer-events-none -z-10 overflow-visible">
        <div className="dynamic-drift-1 absolute -top-8 right-1/4 w-[280px] h-[200px] bg-amber-400/10 dark:bg-amber-500/8 rounded-full blur-[100px]" />
        <div className="dynamic-drift-2 absolute -bottom-8 left-1/4 w-[300px] h-[210px] bg-yellow-400/8 dark:bg-yellow-500/6 rounded-full blur-[110px]" />
        <div className="dynamic-drift-3 absolute top-1/4 left-1/2 -translate-x-1/2 w-[260px] h-[180px] bg-amber-500/8 dark:bg-amber-600/6 rounded-full blur-[90px]" />
      </div>

      <div className="w-full max-w-lg mx-auto flex flex-col items-center">
        
        {/* Promotional Dynamic Rotating Shimmer Banner (Exact Computer Style) */}
        {settings.BANNER_ENABLED !== 'false' && (
          <div className="mb-7 inline-block max-w-full px-2">
        ...
        <div className="w-full px-1 mb-2">
          <h1 className="font-black tracking-tight w-full mb-3.5 [text-wrap:balance]">
            <span className="text-slate-900 dark:text-white block font-black text-[29px] xs:text-[34px] sm:text-4xl leading-[1.2] mb-2 tracking-tight">
              {settings.HERO_TITLE || 'نحو مستقبل برمجي وهندسي احترافي'}
            </span>
            <span className="bg-gradient-to-r from-blue-700 via-indigo-600 to-sky-600 dark:from-amber-300 dark:via-yellow-400 dark:to-amber-500 bg-clip-text text-transparent block font-black text-[18px] xs:text-[21px] sm:text-2xl leading-snug">
        ...
        {/* Action Buttons (نزل الأيقونات تحت ومريحة) */}
        <div className="w-full max-w-sm mx-auto flex flex-col gap-4 mt-8 mb-10 px-1">
        ...
        {/* Quick Contacts (نزل الأيقونات تحت) */}
        {hasAnySocial && (
          <div className="flex flex-wrap items-center justify-center gap-2 pt-4 pb-5 max-w-sm mx-auto">
            ...
            {whatsappUrl && (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full bg-emerald-50 hover:bg-emerald-100 dark:bg-emerald-500/10 dark:hover:bg-emerald-500/20 text-emerald-700 dark:text-emerald-300 border border-emerald-200 dark:border-emerald-500/30 text-xs font-bold transition-all hover:scale-105 shadow-xs"
            ...
            <Link
              href="/support"
              className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full bg-amber-50 hover:bg-amber-100 dark:bg-amber-500/10 dark:hover:bg-amber-500/20 text-amber-700 dark:text-amber-300 border border-amber-200 dark:border-amber-500/30 text-xs font-bold transition-all hover:scale-105 shadow-xs"
            ...
            {contactEmail && (
              <a
                ...
                className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full bg-blue-50 hover:bg-blue-100 dark:bg-blue-500/10 dark:hover:bg-blue-500/20 text-blue-700 dark:text-blue-300 border border-blue-200 dark:border-blue-500/30 text-xs font-semibold transition-all hover:scale-105 shadow-xs"
            ...
            {facebookUrl && (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full bg-indigo-50 hover:bg-indigo-100 dark:bg-blue-600/10 dark:hover:bg-blue-600/20 text-indigo-700 dark:text-blue-400 border border-indigo-200 dark:border-blue-500/30 text-xs font-semibold transition-all hover:scale-105 shadow-xs"
            ...
            {telegramUrl && (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full bg-sky-50 hover:bg-sky-100 dark:bg-sky-500/10 dark:hover:bg-sky-500/20 text-sky-700 dark:text-sky-300 border border-sky-200 dark:border-sky-500/30 text-xs font-semibold transition-all hover:scale-105 shadow-xs"
        ...
        <div className="w-full flex flex-col items-center gap-2.5 max-w-sm mx-auto pt-2">
