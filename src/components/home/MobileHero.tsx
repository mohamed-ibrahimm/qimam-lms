      ...
      <section className="min-h-[calc(100svh-5rem)] flex flex-col justify-between pt-1 pb-4 px-4 text-center relative overflow-hidden">
        ...
        <div className="w-full max-w-lg mx-auto flex flex-col items-center my-auto px-1 py-4 relative">
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[310px] xs:w-[350px] h-[250px] pointer-events-none -z-10 overflow-visible">
            <div className="dynamic-drift-1 absolute -top-4 right-1/4 w-[240px] h-[180px] bg-blue-500/15 dark:bg-amber-400/18 rounded-full blur-[80px]" />
            <div className="dynamic-drift-2 absolute -bottom-4 left-1/4 w-[260px] h-[190px] bg-indigo-500/12 dark:bg-yellow-400/16 rounded-full blur-[85px]" />
            <div className="dynamic-drift-3 absolute top-1/4 left-1/2 -translate-x-1/2 w-[220px] h-[160px] bg-sky-400/14 dark:bg-amber-500/14 rounded-full blur-[75px]" />
            <div className="dynamic-drift-4 absolute -top-8 left-1/3 w-[250px] h-[190px] bg-violet-400/12 dark:bg-yellow-300/10 rounded-full blur-[80px]" />
          </div>

          <h1 className="font-black tracking-tight w-full mb-3.5 [text-wrap:balance]">
            <span className="text-slate-950 dark:text-white block font-black text-[31px] xs:text-[36px] sm:text-4xl leading-[1.18] mb-2.5 tracking-tight">
            ...
            <span className="block font-black text-[18.5px] xs:text-[22px] sm:text-2xl leading-snug bg-gradient-to-r from-blue-700 via-indigo-600 to-violet-700 dark:from-amber-300 dark:via-yellow-400 dark:to-amber-500 dark:animate-gold-text-shimmer bg-clip-text text-transparent">
          ...
          <p className="text-xs xs:text-[13.5px] text-slate-700 dark:text-zinc-300 max-w-sm mx-auto leading-relaxed font-normal px-2">
        ...
        <div className="w-full max-w-sm mx-auto flex flex-col gap-3 pb-2 px-1">
          ...
          <a href="#trending-diploma" className="shimmer-border-wrapper group w-full">
            <div className="shimmer-beam-gold dark:block hidden" />
            <div className="shimmer-beam-blue dark:hidden block" />
            <div className="shimmer-button-content w-full px-6 py-3.5 text-sm xs:text-base font-black text-white bg-gradient-to-r from-blue-600 via-indigo-600 to-blue-700 dark:bg-none dark:text-amber-300 group-hover:opacity-95 flex items-center justify-center gap-2.5">
