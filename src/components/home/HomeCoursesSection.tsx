...
const THEME_STYLES = [
  ...
  },
  {
    ...
    btn: 'bg-gradient-to-r from-purple-600 to-fuchsia-600 hover:from-purple-500 hover:to-fuchsia-500 text-white shadow-purple-500/25',
    btnDark: 'bg-gradient-to-r from-purple-500 to-fuchsia-500 hover:from-purple-400 hover:to-fuchsia-400 text-white shadow-purple-500/25',
  ...
  },
  {
    ...
    btn: 'bg-gradient-to-r from-amber-500 via-yellow-500 to-amber-600 hover:from-amber-400 hover:to-yellow-400 text-zinc-950 font-black shadow-amber-500/25',
    btnDark: 'bg-gradient-to-r from-amber-400 via-yellow-400 to-amber-500 hover:from-amber-300 hover:to-yellow-300 text-zinc-950 font-black shadow-amber-500/25',
  ...
  },
  {
    ...
    aura: 'from-rose-500/15 via-pink-500/5 to-transparent',
    badge: 'bg-rose-500/15 text-rose-300 border-rose-500/30',
    glowBorder: 'hover:border-rose-500/50 hover:shadow-[0_0_30px_rgba(244,63,94,0.18)]',
    ...
    btn: 'bg-gradient-to-r from-rose-600 to-pink-600 hover:from-rose-500 hover:to-pink-500 text-white shadow-rose-500/25',
    btnDark: 'bg-gradient-to-r from-rose-500 to-pink-500 hover:from-rose-400 hover:to-pink-400 text-white shadow-rose-500/25',
    ...
    <section id="all-courses" className="px-4 sm:px-6 lg:px-10 py-14 sm:py-20 relative scroll-mt-20">
      <div className="max-w-[1440px] mx-auto space-y-10">
        ...
        {categories.length > 0 && (
          <div className="flex items-center justify-center gap-2.5 overflow-x-auto pb-2 scrollbar-none px-2">
            <button
              ...
              className={`px-5 py-2 rounded-full text-xs sm:text-sm font-black transition-all whitespace-nowrap shrink-0 flex items-center gap-2 shadow-xs cursor-pointer ${
        ...
        {filteredCourses.length === 0 && (
          <div className="p-12 text-center rounded-2xl bg-slate-50 dark:bg-zinc-900/40 border border-slate-200 dark:border-zinc-800 text-slate-500 dark:text-zinc-400">
