    ...
    <>
      ...
      <aside aria-label="تواصل واتساب">
        <a
          ...
          className="fixed bottom-2.5 sm:bottom-5 left-2.5 sm:left-6 z-50 flex items-center gap-2 p-2 sm:px-4 sm:py-2.5 rounded-full bg-[#25D366] hover:bg-[#20bd5a] text-white shadow-xl shadow-emerald-600/35 hover:shadow-2xl hover:scale-105 active:scale-95 transition-all group border border-white/40 backdrop-blur-sm cursor-pointer"
