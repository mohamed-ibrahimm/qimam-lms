...
export default function Header({
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 p-2 sm:p-3.5 md:p-4 transition-all">
      {/* Soft, Subtle Ambient Glow (Toned Down & Elegant) */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[75%] max-w-4xl h-12 bg-gradient-to-r from-amber-500/10 via-yellow-400/10 to-purple-600/10 dark:from-amber-500/12 dark:via-purple-600/12 dark:to-amber-500/12 blur-[65px] pointer-events-none -z-10 rounded-full" />
