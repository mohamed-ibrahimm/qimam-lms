...
export default function AdminSettingsPage() {
  ...
  // Sync tab with URL search parameter whenever URL changes (e.g. sidebar navigation)
  useEffect(() => {
    const tab = searchParams.get('tab');
    if (tab && ['pricing', 'content', 'contacts', 'payments', 'workflow', 'all'].includes(tab)) {
      setActiveTab(tab as any);
    }
  }, [searchParams]);

  const handleTabChange = (tabId: 'all' | 'pricing' | 'content' | 'contacts' | 'payments' | 'workflow') => {
    setActiveTab(tabId);
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-5 pb-20 text-slate-900 dark:text-slate-100">
      
      {/* =========================================================================
          HEADER & SAVE ACTION
         ========================================================================= */}
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 p-4 sm:p-5 rounded-3xl bg-white dark:bg-[#120d24] border border-slate-200 dark:border-amber-500/30 shadow-xl dark:shadow-[0_10px_30px_rgba(0,0,0,0.5)]">
        <div className="space-y-1">
          <div className="inline-flex items-center gap-1.5 px-3 py-0.5 rounded-full bg-amber-500/15 border border-amber-500/30 text-amber-800 dark:text-amber-300 text-xs font-black">
      ...
      {/* =========================================================================
          RESPONSIVE LUXURY TABS NAVIGATION (NO OVERFLOW CUTOFF)
         ========================================================================= */}
        ...
        {tabs.map((tab) => {
          ...
          return (
            <button
              ...
              className={`px-3 py-2.5 rounded-2xl text-xs font-bold transition-all flex items-center justify-center gap-1.5 cursor-pointer ${
                isActive
            ...
            >
              <Icon className={`w-3.5 h-3.5 shrink-0 ${isActive ? 'text-zinc-950' : 'text-amber-500'}`} />
      ...
      <form onSubmit={handleSave} className="space-y-6">
        ...
        {(activeTab === 'pricing' || activeTab === 'all') && (
          <div className="p-5 sm:p-6 rounded-3xl bg-white dark:bg-[#120d24] border border-slate-200 dark:border-amber-500/30 shadow-xl space-y-5 animate-in fade-in">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <div className="p-4 rounded-2xl bg-slate-50 dark:bg-[#0b0816] border border-purple-200 dark:border-purple-900/40 space-y-2 shadow-sm">
                ...
                <div className="relative">
                  <input
                    ...
                    placeholder="290"
                    className="w-full px-3.5 py-2 rounded-xl bg-white dark:bg-zinc-950 border border-slate-200 dark:border-purple-900/60 text-slate-900 dark:text-white text-base font-mono font-black focus:outline-none focus:border-purple-500 shadow-inner"
                  />
                  <span className="absolute left-3 top-2 text-xs text-slate-500 dark:text-zinc-400 font-bold">ج.م / شهر</span>
                </div>
              ...
              <div className="p-4 rounded-2xl bg-slate-50 dark:bg-[#0b0816] border border-indigo-200 dark:border-indigo-900/40 space-y-2 shadow-sm">
                <label className="block text-xs font-black text-slate-900 dark:text-white flex items-center justify-between">
                  <span className="flex items-center gap-1.5">
                ...
                <div className="relative">
                  <input
                    ...
                    placeholder="1499"
                    className="w-full px-3.5 py-2 rounded-xl bg-white dark:bg-zinc-950 border border-slate-200 dark:border-indigo-900/60 text-slate-900 dark:text-white text-base font-mono font-black focus:outline-none focus:border-indigo-500 shadow-inner"
                  />
                  <span className="absolute left-3 top-2 text-xs text-slate-500 dark:text-zinc-400 font-bold">ج.م / سنة</span>
                </div>
                <p className="text-[11px] text-slate-500 dark:text-zinc-400 leading-relaxed">
              ...
              {/* Student Plan Price */}
              <div className="p-4 rounded-2xl bg-amber-50/50 dark:bg-[#0e0914] border-2 border-amber-300 dark:border-amber-500/40 space-y-2 shadow-sm">
                <label className="block text-xs font-black text-slate-900 dark:text-white flex items-center justify-between">
                  <span className="flex items-center gap-1.5">
                ...
                <div className="relative">
                  <input
                    ...
                    placeholder="120"
                    className="w-full px-3.5 py-2 rounded-xl bg-white dark:bg-zinc-950 border border-amber-300 dark:border-amber-500/50 text-slate-900 dark:text-white text-base font-mono font-black focus:outline-none focus:border-amber-500 shadow-inner"
                  />
                  <span className="absolute left-3 top-2 text-xs text-slate-500 dark:text-zinc-400 font-bold">ج.م / شهر</span>
                </div>
                <p className="text-[11px] text-slate-500 dark:text-zinc-400 leading-relaxed">
              ...
              <div className="p-4 rounded-2xl bg-slate-50 dark:bg-[#0b0816] border border-slate-200 dark:border-zinc-800 space-y-2 shadow-sm">
                <label className="block text-xs font-black text-slate-900 dark:text-white flex items-center justify-between">
                ...
                <div className="relative">
                  <input
                    ...
                    placeholder="30"
                    className="w-full px-3.5 py-2 rounded-xl bg-white dark:bg-zinc-950 border border-slate-200 dark:border-zinc-800 text-slate-900 dark:text-white text-base font-mono font-black focus:outline-none focus:border-amber-500 shadow-inner"
                  />
                  <span className="absolute left-3 top-2 text-xs text-slate-500 dark:text-zinc-400 font-bold">يوم</span>
                </div>
                <p className="text-[11px] text-slate-500 dark:text-zinc-400 leading-relaxed">
              ...
              <div className="p-4 rounded-2xl bg-slate-50 dark:bg-[#0b0816] border border-slate-200 dark:border-zinc-800 space-y-2 shadow-sm">
                ...
                <div className="relative">
                  <input
                    ...
                    placeholder="14"
                    className="w-full px-3.5 py-2 rounded-xl bg-white dark:bg-zinc-950 border border-slate-200 dark:border-zinc-800 text-slate-900 dark:text-white text-base font-mono font-black focus:outline-none focus:border-purple-500 shadow-inner"
                  />
                  <span className="absolute left-3 top-2 text-xs text-slate-500 dark:text-zinc-400 font-bold">يوم</span>
                </div>
                <p className="text-[11px] text-slate-500 dark:text-zinc-400 leading-relaxed">
              ...
              <div className="p-4 rounded-2xl bg-slate-50 dark:bg-[#0b0816] border border-slate-200 dark:border-zinc-800 space-y-2 shadow-sm">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full px-3.5 py-2 rounded-xl bg-white dark:bg-zinc-950 border border-slate-200 dark:border-zinc-800 text-slate-900 dark:text-white text-base font-mono font-black focus:outline-none focus:border-amber-500 shadow-inner"
                  />
                  <span className="absolute left-3 top-2 text-xs text-slate-500 dark:text-zinc-400 font-bold">سنة</span>
                </div>
                <p className="text-[11px] text-slate-500 dark:text-zinc-400 leading-relaxed">
              ...
              <div className="p-4 rounded-2xl bg-slate-50 dark:bg-[#0b0816] border border-slate-200 dark:border-zinc-800 space-y-2 shadow-sm">
                ...
                <div className="relative">
                  <input
                    ...
                    placeholder="0"
                    className="w-full px-3.5 py-2 rounded-xl bg-white dark:bg-zinc-950 border border-slate-200 dark:border-zinc-800 text-slate-900 dark:text-white text-base font-mono font-black focus:outline-none focus:border-emerald-500 shadow-inner"
                  />
                  <span className="absolute left-3 top-2 text-xs text-slate-500 dark:text-zinc-400 font-bold">%</span>
                </div>
                <p className="text-[11px] text-slate-500 dark:text-zinc-400 leading-relaxed">
        ...
        {(activeTab === 'content' || activeTab === 'all') && (
          <div className="p-5 sm:p-6 rounded-3xl bg-white dark:bg-[#120d24] border border-slate-200 dark:border-amber-500/30 shadow-xl space-y-5 animate-in fade-in">
            ...
            <div className="p-4 sm:p-5 rounded-2xl bg-slate-50 dark:bg-[#0b0816] border border-slate-200 dark:border-zinc-800 space-y-4">
        ...
        {(activeTab === 'contacts' || activeTab === 'all') && (
          <div className="space-y-5 animate-in fade-in">
            {/* Identity */}
            <div className="p-5 sm:p-6 rounded-3xl bg-white dark:bg-[#120d24] border border-slate-200 dark:border-amber-500/30 shadow-xl space-y-4">
        ...
        {(activeTab === 'payments' || activeTab === 'all') && (
          <div className="p-5 sm:p-6 rounded-3xl bg-white dark:bg-[#120d24] border border-slate-200 dark:border-amber-500/30 shadow-xl space-y-5 animate-in fade-in">
            <div className="flex items-center gap-2 text-sm font-black text-amber-700 dark:text-amber-400 pb-3 border-b border-slate-200 dark:border-zinc-800">
