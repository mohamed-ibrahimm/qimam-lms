  ...
  return (
    <div className="page-canvas relative overflow-hidden pb-24 text-zinc-100">
      ...
      <div className="relative z-10 space-y-16 sm:space-y-20 md:space-y-28">
        ...
        <section className="pt-4 sm:pt-10 pb-8 md:pt-16 md:pb-20">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            
            {/* Promotional Dynamic Rotating Shimmer Banner */}
            {(settings.BANNER_ENABLED !== 'false') && (
              <div className="mb-4 sm:mb-8 inline-block max-w-full px-2">
                <a href="#trending-diploma" className="shimmer-border-wrapper group inline-block max-w-full">
                  <div className="shimmer-beam-gold" />
                  <div className="shimmer-button-content px-4 sm:px-6 py-2 sm:py-2.5 text-xs sm:text-sm text-slate-800 dark:text-zinc-200 flex items-center gap-2 sm:gap-3 flex-nowrap justify-center">
                    ...
                    <span className="group-hover:text-blue-700 dark:group-hover:text-amber-200 transition-colors font-semibold text-xs sm:text-sm leading-normal">
            ...
            <div className="relative px-2">
              ...
              <h1 className="font-black tracking-tight mb-4 sm:mb-6 max-w-5xl mx-auto">
                <span className="text-slate-900 dark:text-white block font-black text-2xl xs:text-3xl sm:text-5xl md:text-6xl leading-[1.25] sm:leading-[1.15] mb-2 sm:mb-3">
                  {settings.HERO_TITLE || 'نحو مستقبل برمجي وهندسي احترافي'}
                </span>
                <span className="bg-gradient-to-r from-blue-700 via-indigo-600 to-sky-600 dark:from-amber-300 dark:via-yellow-400 dark:to-amber-500 bg-clip-text text-transparent block font-black text-lg xs:text-2xl sm:text-3xl md:text-4xl leading-snug">
            ...
            <p className="text-sm xs:text-base sm:text-lg md:text-xl text-slate-600 dark:text-zinc-300 max-w-3xl mx-auto mb-6 sm:mb-10 leading-relaxed font-normal px-2">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-5 w-full max-w-md sm:max-w-none mx-auto px-2">
              <a href="#trending-diploma" className="w-full sm:w-auto shimmer-border-wrapper group">
                <div className="shimmer-beam-gold" />
                <div className="shimmer-button-content px-7 sm:px-9 py-3.5 sm:py-4 text-sm sm:text-base font-black text-white dark:text-amber-300 group-hover:opacity-95 flex items-center justify-center gap-2.5">
                  <Flame className="w-4 h-4 sm:w-5 sm:h-5 text-amber-400 animate-bounce shrink-0" />
                  <span className="whitespace-nowrap">{settings.FEATURED_DIPLOMA_BADGE || 'الدبلومة الأكثر طلباً (خصم 51%)'}</span>
                  <ArrowLeft className="w-4 h-4 sm:w-5 sm:h-5 text-white dark:text-amber-400 group-hover:-translate-x-1.5 transition-transform duration-300 shrink-0" />
                </div>
              </a>

              <Link
                href="/courses"
                className="w-full sm:w-auto group flex items-center justify-center gap-2.5 px-7 sm:px-8 py-3.5 sm:py-4 text-sm sm:text-base font-black text-slate-800 hover:text-blue-700 dark:text-zinc-200 dark:hover:text-white transition-all rounded-full border border-slate-300/90 hover:border-blue-500 bg-white/95 hover:bg-white dark:border-zinc-800/80 dark:bg-zinc-900/60 dark:hover:border-zinc-700 dark:hover:bg-zinc-900 shadow-sm hover:shadow-md backdrop-blur-md"
              >
                <BookOpen className="w-4 h-4 sm:w-5 sm:h-5 text-blue-600 dark:text-amber-400 group-hover:scale-110 transition-transform shrink-0" />
                <span className="whitespace-nowrap">{settings.HERO_CTA_PRIMARY || 'تصفح دليل الكورسات'}</span>
                <ArrowLeft className="w-4 h-4 sm:w-5 sm:h-5 group-hover:-translate-x-1 transition-transform duration-300 shrink-0" />
              </Link>
            </div>
              ...
              <div className="flex flex-wrap items-center justify-center gap-2 sm:gap-3 pt-6 sm:pt-8 pb-2">
                ...
                {whatsappUrl && (
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-emerald-50 hover:bg-emerald-100 dark:bg-emerald-500/10 dark:hover:bg-emerald-500/20 text-emerald-700 dark:text-emerald-300 border border-emerald-200 dark:border-emerald-500/30 text-xs sm:text-sm font-bold transition-all hover:scale-105 shadow-xs"
                ...
                <Link
                  href="/support"
                  className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-amber-50 hover:bg-amber-100 dark:bg-amber-500/10 dark:hover:bg-amber-500/20 text-amber-700 dark:text-amber-300 border border-amber-200 dark:border-amber-500/30 text-xs sm:text-sm font-bold transition-all hover:scale-105 shadow-xs"
