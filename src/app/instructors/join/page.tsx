...
export default function InstructorJoinPage() {
  ...
  return (
    <div className="min-h-screen pt-4 sm:pt-6 pb-12 px-3.5 sm:px-6 lg:px-8 relative overflow-hidden bg-slate-50 dark:bg-[#07050e] text-slate-900 dark:text-slate-100 selection:bg-amber-500 selection:text-zinc-950 transition-colors duration-300">
      
      {/* =========================================================================
          CENTERED DYNAMIC ANIMATED GLOWING BACKGROUND (MATCHING HOMEPAGE DESKTOPHERO)
         ========================================================================= */}
      <div className="absolute top-28 sm:top-36 left-1/2 -translate-x-1/2 w-full max-w-4xl h-[400px] pointer-events-none -z-10 overflow-visible">
        <div className="dynamic-drift-1 absolute -top-8 right-1/4 w-[450px] h-[320px] bg-amber-400/20 dark:bg-amber-500/16 rounded-full blur-[110px]" />
        <div className="dynamic-drift-2 absolute -bottom-8 left-1/4 w-[480px] h-[340px] bg-purple-500/20 dark:bg-purple-600/16 rounded-full blur-[120px]" />
        <div className="dynamic-drift-3 absolute top-1/4 left-1/2 -translate-x-1/2 w-[400px] h-[300px] bg-yellow-400/15 dark:bg-yellow-500/10 rounded-full blur-[100px]" />
      </div>
      ...
      <section className="max-w-5xl mx-auto text-center">
        ...
        <div className="inline-flex p-1 rounded-2xl sm:rounded-full bg-white/90 dark:bg-[#130f24]/95 border border-slate-200 dark:border-amber-500/30 shadow-md shadow-slate-900/5 dark:shadow-[0_10px_30px_rgba(0,0,0,0.5)] backdrop-blur-2xl gap-1 flex-col sm:flex-row justify-center w-full sm:w-auto mb-2.5 sm:mb-3">
          <button
            type="button"
        ...
        {/* Main Headline */}
        <h1 className="text-2xl xs:text-3xl sm:text-4xl lg:text-5xl font-black text-slate-900 dark:text-white tracking-tight leading-[1.2] max-w-4xl mx-auto mb-2">
          {platformSettings.joinPageTitle ? (
            platformSettings.joinPageTitle
          ) : activeTrack === 'student' ? (
            <>
              اشرح لزملائك وأطلق أول كورس لك مع{' '}
              <span className="bg-gradient-to-r from-amber-500 via-yellow-400 to-amber-500 dark:from-amber-300 dark:via-yellow-300 dark:to-amber-400 bg-clip-text text-transparent drop-shadow-[0_2px_15px_rgba(245,158,11,0.35)]">
            ...
            <>
              ...
              <span className="bg-gradient-to-r from-purple-600 via-indigo-600 to-purple-600 dark:from-amber-300 dark:via-yellow-300 dark:to-amber-400 bg-clip-text text-transparent drop-shadow-[0_2px_15px_rgba(245,158,11,0.35)]">
        ...
        {/* Subtitle */}
        <p className="text-xs sm:text-sm text-slate-600 dark:text-zinc-300 max-w-2xl mx-auto leading-relaxed px-2 mb-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-5 text-right max-w-4xl mx-auto">
          ...
          <div
            className={`p-4 sm:p-6 rounded-3xl border transition-all duration-300 flex flex-col justify-between space-y-3.5 relative overflow-hidden group ${
              activeTrack === 'expert' || activeTrack === 'all'
                ? 'bg-white dark:bg-[#110d22]/95 border-purple-200 dark:border-purple-500/40 shadow-xl shadow-purple-500/5 dark:shadow-[0_15px_40px_-10px_rgba(0,0,0,0.7),0_0_25px_-5px_rgba(147,51,234,0.2)] ring-1 ring-purple-500/20'
                : 'bg-slate-50/50 dark:bg-[#120e24]/50 border-slate-200 dark:border-zinc-800/70 opacity-70'
            }`}
          >
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <span className="px-2.5 py-1 rounded-full bg-purple-500/10 dark:bg-purple-500/15 text-purple-700 dark:text-purple-300 border border-purple-500/20 dark:border-purple-500/30 text-xs font-bold inline-flex items-center gap-1.5">
              ...
              <div className="p-3.5 rounded-2xl bg-purple-50/60 dark:bg-[#0b0816] border border-purple-100 dark:border-purple-900/40 space-y-2 text-xs">
            ...
            <Link
              ...
              className="w-full py-3 rounded-2xl bg-gradient-to-r from-purple-600 via-indigo-600 to-purple-600 hover:from-purple-500 hover:to-indigo-500 text-white font-black text-xs text-center shadow-md shadow-purple-600/20 transition-all hover:scale-[1.01] flex items-center justify-center gap-2 cursor-pointer"
            >
          ...
          <div
            className={`p-4 sm:p-6 rounded-3xl border-2 transition-all duration-300 flex flex-col justify-between space-y-3.5 relative overflow-hidden group ${
              activeTrack === 'student' || activeTrack === 'all'
                ? 'bg-gradient-to-b from-amber-50/80 via-white to-amber-50/40 dark:from-[#1a1309]/95 dark:via-[#130d1c]/95 dark:to-[#090612]/95 border-amber-400 dark:border-amber-500/60 shadow-xl shadow-amber-500/10 dark:shadow-[0_15px_40px_-10px_rgba(0,0,0,0.7),0_0_30px_-5px_rgba(245,158,11,0.25)] ring-1 ring-amber-400/40'
                : 'bg-slate-50/50 dark:bg-[#120e24]/50 border-slate-200 dark:border-zinc-800/70 opacity-70'
            }`}
          >
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <span className="px-2.5 py-1 rounded-full bg-amber-500/15 text-amber-800 dark:text-amber-300 border border-amber-500/30 text-xs font-black inline-flex items-center gap-1.5">
              ...
              <div className="p-3.5 rounded-2xl bg-amber-500/10 dark:bg-[#0e0914] border border-amber-200 dark:border-amber-500/30 space-y-2 text-xs">
                <div className="flex items-center justify-between font-bold text-slate-700 dark:text-zinc-300">
            ...
            <Link
              ...
              className="w-full py-3 rounded-2xl bg-gradient-to-r from-amber-500 via-yellow-400 to-amber-500 hover:from-amber-400 hover:to-yellow-300 text-zinc-950 font-black text-xs text-center shadow-md shadow-amber-500/25 transition-all hover:scale-[1.01] flex items-center justify-center gap-2 cursor-pointer"
            >
      ...
      {/* =========================================================================
         ...
         ========================================================================= */}
      <section className="max-w-4xl mx-auto py-8 sm:py-10">
        <div className="p-5 sm:p-7 rounded-3xl bg-white dark:bg-[#110d22]/95 border border-slate-200 dark:border-amber-500/30 shadow-xl dark:shadow-[0_15px_40px_-10px_rgba(0,0,0,0.7),0_0_25px_-5px_rgba(245,158,11,0.15)] space-y-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5 pt-1">
            <div className="space-y-3.5">
              <div className="space-y-1.5">
                <div className="flex justify-between text-xs font-bold text-slate-700 dark:text-zinc-200">
                  ...
                  <span className="text-amber-600 dark:text-amber-400 font-mono text-xs">{studentCount} طالب</span>
                </div>
                <input
                  type="range"
                  min="10"
              ...
              <div className="space-y-1.5">
                <div className="flex justify-between text-xs font-bold text-slate-700 dark:text-zinc-200">
                  ...
                  <span className="text-amber-600 dark:text-amber-400 font-mono text-xs">{coursePrice} ج.م</span>
                </div>
                <input
                  type="range"
                  min="100"
            ...
            <div className="p-4 rounded-2xl bg-slate-50 dark:bg-[#0b0816] border border-slate-200 dark:border-amber-500/20 flex flex-col justify-between space-y-3">
              <div className="space-y-1">
                <span className="text-[11px] font-medium text-slate-500 dark:text-zinc-400">صافي أرباحك في منصتنا (100% لك):</span>
      ...
      {/* =========================================================================
         ...
         ========================================================================= */}
      <section className="max-w-6xl mx-auto py-8 sm:py-10 space-y-6 sm:space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5">
          {features.map((f) => {
            ...
            return (
              <div
                key={f.number}
                className={`p-4 sm:p-5 rounded-3xl bg-white dark:bg-[#110d22]/90 border border-slate-200 dark:border-zinc-800 transition-all duration-300 hover:-translate-y-1 shadow-sm hover:shadow-md space-y-3 group`}
              >
                <div className="flex items-center justify-between">
                  <div className={`w-9 h-9 rounded-2xl border flex items-center justify-center ${f.iconCol}`}>
                ...
                <h3 className="text-xs sm:text-sm font-black text-slate-900 dark:text-white group-hover:text-amber-600 dark:group-hover:text-amber-300 transition-colors">
                  {f.title}
                </h3>
      ...
      {/* =========================================================================
         ...
         ========================================================================= */}
      <section className="max-w-4xl mx-auto py-8 sm:py-10">
        <div className="p-4 sm:p-6 rounded-3xl bg-white dark:bg-[#110d22]/90 border border-slate-200 dark:border-amber-500/30 shadow-xl space-y-5">
          <div className="text-center space-y-1">
            <h2 className="text-lg sm:text-xl font-black text-slate-900 dark:text-white">
            ...
            <table className="w-full text-right text-xs">
              <thead>
                <tr className="border-b border-slate-200 dark:border-zinc-800 text-slate-500 dark:text-zinc-400">
                  <th className="py-2.5 px-3 font-bold">الميزة</th>
                  <th className="py-2.5 px-3 font-black text-amber-600 dark:text-amber-400">منصتنا التعليمية</th>
                  <th className="py-2.5 px-3 font-bold text-slate-400 dark:text-zinc-500">المنصات التقليدية الأخرى</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-slate-100 dark:divide-zinc-800/60 font-medium">
                <tr>
                  <td className="py-2.5 px-3 text-slate-900 dark:text-white font-bold">نسبة عمولة المبيعات</td>
                  <td className="py-2.5 px-3 text-emerald-600 dark:text-emerald-400 font-bold">0% (كامل الأرباح لك)</td>
                  <td className="py-2.5 px-3 text-rose-500">30% إلى 50% من كل عملية بيع</td>
                </tr>
                <tr>
                  <td className="py-2.5 px-3 text-slate-900 dark:text-white font-bold">استلام الأموال</td>
                  <td className="py-2.5 px-3 text-emerald-600 dark:text-emerald-400 font-bold">لحظي ومباشر على InstaPay والمحافظ</td>
                  <td className="py-2.5 px-3 text-slate-500 dark:text-zinc-400">شهرياً مع رسوم تحويل إضافية</td>
                </tr>
                <tr>
                  <td className="py-2.5 px-3 text-slate-900 dark:text-white font-bold">حماية الفيديوهات</td>
                  <td className="py-2.5 px-3 text-emerald-600 dark:text-emerald-400 font-bold">علامة مائية ديناميكية ببيانات الطالب</td>
                  <td className="py-2.5 px-3 text-slate-500 dark:text-zinc-400">حماية تقليدية سهلة التسجيل</td>
                </tr>
                <tr>
                  <td className="py-2.5 px-3 text-slate-900 dark:text-white font-bold">دعم الطلبة المحاضرين</td>
                  <td className="py-2.5 px-3 text-emerald-600 dark:text-emerald-400 font-bold">منحة شهر كامل مجاناً وباقة مدعومة</td>
                  <td className="py-2.5 px-3 text-rose-500">لا يوجد باقات خاصة للطلاب</td>
                </tr>
                <tr>
                  <td className="py-2.5 px-3 text-slate-900 dark:text-white font-bold">الشهادات المعتمدة</td>
                  <td className="py-2.5 px-3 text-emerald-600 dark:text-emerald-400 font-bold">شهادات ذكية برمز QR للتحقق</td>
                  <td className="py-2.5 px-3 text-slate-500 dark:text-zinc-400">شهادات صور غير قابلة للتحقق</td>
                </tr>
              </tbody>
            </table>
          </div>
      ...
      {/* =========================================================================
         ...
         ========================================================================= */}
      <section className="max-w-4xl mx-auto text-center py-8 sm:py-10">
        <div className="p-6 sm:p-10 rounded-3xl bg-gradient-to-r from-amber-500/10 via-purple-600/10 to-amber-500/10 dark:from-amber-500/20 dark:via-purple-600/20 dark:to-amber-500/20 border-2 border-amber-400/40 dark:border-amber-500/40 shadow-xl backdrop-blur-xl space-y-5">
          <div className="w-11 h-11 sm:w-12 sm:h-12 rounded-2xl bg-amber-500/20 border border-amber-500/40 flex items-center justify-center mx-auto text-amber-600 dark:text-amber-400 shadow-md">
            <GraduationCap className="w-5 h-5 sm:w-6 sm:h-6" />
          </div>

          <div className="space-y-1.5">
            <h2 className="text-lg sm:text-2xl lg:text-3xl font-black text-slate-900 dark:text-white tracking-tight">
